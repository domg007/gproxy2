...
mod tests {
    ...
    fn deserializes_cancel_response_payload() {
        ...
        assert_eq!(parsed.id, "resp_67cb71b351908190a308f3859487620d06981a8637e6bc44");
        assert_eq!(parsed.status, Some(crate::openai::create_response::types::ResponseStatus::Cancelled));
    }
}
