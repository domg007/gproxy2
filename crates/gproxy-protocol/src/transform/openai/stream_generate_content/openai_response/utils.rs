...
use crate::openai::create_response::stream::{
    OpenAiCreateResponseSseData, OpenAiCreateResponseSseEvent, ResponseStreamEvent,
};
...
pub fn push_stream_event(
    ...
    out.push(OpenAiCreateResponseSseEvent {
        event: None,
        data: OpenAiCreateResponseSseData::Event(stream_event),
    });
}

pub fn push_done_event(out: &mut Vec<OpenAiCreateResponseSseEvent>) {
    out.push(OpenAiCreateResponseSseEvent {
        event: None,
