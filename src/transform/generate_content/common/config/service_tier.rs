...
pub(in crate::transform::generate_content) fn openai_service_tier_to_claude(
...
pub(in crate::transform::generate_content) fn claude_service_tier_to_openai(
...
pub(in crate::transform::generate_content) fn gemini_service_tier_to_openai(
...
pub(in crate::transform::generate_content) fn claude_service_tier_to_gemini(
    service_tier: Option<claude::RequestServiceTier>,
) -> Option<gemini::ServiceTier> {
    let tier = match service_tier? {
        claude::RequestServiceTier::Known(claude::RequestServiceTierKnown::Auto) => {
...
pub(in crate::transform::generate_content) fn gemini_service_tier_to_claude(
    service_tier: Option<gemini::ServiceTier>,
) -> Option<claude::RequestServiceTier> {
    let tier = match service_tier? {
        gemini::ServiceTier::Known(gemini::ServiceTierKnown::Standard) => {
