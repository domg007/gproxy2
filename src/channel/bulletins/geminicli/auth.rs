...
/// Default redirect_uri the Gemini CLI login uses (mined from v1
/// `GEMINICLI_REDIRECT_URI`) — the CLI's loopback callback listener.
pub(super) const DEFAULT_REDIRECT_URI: &str = "http://127.0.0.1:1455/oauth2callback";
