...
//!
//! Ported verbatim from v1 `channels/chatgpt/pow.rs` (itself reverse-engineered
...
//! Every constant is byte-exact — any drift is rejected by the server.

use super::config::{ConfigOptions, build_base_config, encode_config};
...
#[cfg(test)]
mod tests {
    use super::super::config::ConfigOptions;
    use super::*;
    use base64::{Engine as _, engine::general_purpose::STANDARD};
